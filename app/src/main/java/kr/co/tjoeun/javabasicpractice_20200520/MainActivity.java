package kr.co.tjoeun.javabasicpractice_20200520;
...
import kr.co.tjoeun.javabasicpractice_20200520.databinding.ActivityMainBinding;
...
//                .equals 로 비교하자.
                if (inputId.equals("admin") && inputPw.equals("qwer")) {
                    ...
                    Toast.makeText(MainActivity.this, "관리자 입니다.", Toast.LENGTH_SHORT).show();
